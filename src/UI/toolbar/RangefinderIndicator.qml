...
Item {
    ...
    property bool showIndicator: _hasRangefinder

    property var    _activeVehicle:     QGroundControl.multiVehicleManager.activeVehicle
    property var    _distanceSensors:   _activeVehicle ? _activeVehicle.distanceSensors : null
    property bool   _hasRangefinder:    _distanceSensors && _distanceSensors.telemetryAvailable
    property real   _distance:          _distanceSensors ? _distanceSensors.rotationPitch270.rawValue : NaN
    property real   _maxDistance:       _distanceSensors ? _distanceSensors.maxDistance.rawValue : NaN
        ...
        ToolIndicatorPage {
            ...
            contentComponent: SettingsGroupLayout {
                ...
                LabelledLabel {
                    ...
                    labelText:  !isNaN(_maxDistance) ? _maxDistance.toFixed(1) + " " + _units : qsTr("--")
                }
            }
        }
    }
