...
public:
    ...
    DEFINE_SETTINGFACT(offlineMetaData)
    ...
    Q_PROPERTY(QString linkLogSavePath          READ linkLogSavePath            NOTIFY savePathsChanged)
    ...
    static constexpr const char* linkLogsDirectory =        QT_TRANSLATE_NOOP("AppSettings", "LinkLogs");
