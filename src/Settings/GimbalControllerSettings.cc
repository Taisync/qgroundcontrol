...
DECLARE_SETTINGSFACT(GimbalControllerSettings, forceShowGimbalIndicator)
DECLARE_SETTINGSFACT(GimbalControllerSettings, defaultGimbalComponentId)
DECLARE_SETTINGSFACT(GimbalControllerSettings, defaultGimbalDeviceId)
